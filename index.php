            ...
            <div class="container-xl d-flex justify-content-center align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample07XL">
                    <ul class="navbar-nav col-lg-10 justify-content-center">
                        ...
                        <li class="nav-item px-3">
                            <a class="nav-link" href="content/profil.php"> Profil </a>
                        </li>
                        <li class="nav-item px-3">
                            <a class="nav-link" href="content/galeri.php"> Galeri </a>
                        </li>
                        <li class="nav-item px-3">
                            <a class="nav-link" href="content/kontak.php"> Kontak </a>
                        </li>
                        <div>
                            <?php 
                            session_start();
...
<!-- isi -->
        ...
        <img draggable="false" src="gambar/welcome.jpg" class="mx-auto d-block img-fluid">
<br><br>

    <!-- Konten Utama -->
    <div class="container mt-5">
        <p style="font-size: 30px"> Roma 12 : 12 Bersukacitalah dalam pengharapan, sabarlah dalam kesesakan, dan bertekunlah dalam doa!</p>
    </div>
