...
$sql = "SELECT * FROM tbl_galeri WHERE kd_ibadah = '$id'";
...
<body>
    ...
    <main class="container mt-4">
        ...
        <form action="galeri_proses.php" method="POST" enctype="multipart/form-data" class="text-white">
            ...
            <input type="hidden" name="original_kd_ibadah" value="<?php echo htmlspecialchars($row['kd_ibadah']); ?>" />
            <div class="mb-3">
                ...
                <select class="form-select" id="kd_ibadah" name="kd_ibadah" required>
                    ...
                    <?php
                    $options = ["SEKOLAH MINGGU", "REBUZA", "PEBUZA", "PERSEKUTUAN DOA", "PRIBUZA", "WABUZA"];
